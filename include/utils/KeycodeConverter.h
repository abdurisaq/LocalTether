...
#define VK_KANA           0x15
#define VK_HANGUL         0x15  /* old name - should be VK_KANA */
#define VK_IME_ON         0x16
#define VK_JUNJA          0x17
#define VK_FINAL          0x18
#define VK_HANJA          0x19
#define VK_KANJI          0x19  /* old name - should be VK_HANJA */
...
#define VK_LWIN           0x5B
#define VK_RWIN           0x5C
#define VK_APPS           0x5D // Context Menu key
...
#define VK_ADD            0x6B
#define VK_SEPARATOR      0x6C // Numpad comma on some layouts, or a specific separator key
...
#define VK_PACKET         0xE7   // Used to pass Unicode characters as if they were keystrokes.
